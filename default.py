...
_C.MODEL.LAMBDA_KNN=0.01
_C.MODEL.LAMBDA_SELF=0.01*2
_C.MODEL.LAMBDA_RAN=0.01*2
_C.MODEL.B_KNN=0.3
_C.MODEL.B_SELF=0.3
_C.MODEL.B_RAN=0.3

# domain disentangled loss 
_C.GRL_LOSS_TYPE = 'crossentropy'
# ID/triplet
...
# camera as domain
_C.DATALOADER.CAMERA_TO_DOMAIN = True # True when single-source
